...
public class HierachicalClusterMiner implements Serializable {
	...
	private static final String DIRECTORY_PATH = "./Spring/src/main/java/Server/saved";
	...
	public class ClusteringService {
		...
		// Metodo per creare un'istanza con il valore fornito dall'utente
		public HierachicalClusterMiner createClusterMiner(int depth) throws NegativeDepthException {
			return new HierachicalClusterMiner(depth);
		}
		
		// Altri metodi per operazioni di clustering
}
	 ...
	 */
	public String getDendrogramAsString(Data data) {
		return dendrogram.toString(data);
	}
}
