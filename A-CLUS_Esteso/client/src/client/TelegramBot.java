...
public class TelegramBot implements LongPollingUpdateConsumer {
    ...
    /** <h4>Mappa che tiene traccia dello stato di ogni utente identificato dal suo {@code chatId}.</h4> */
    private final Map<Long, StateContext> userStates = new ConcurrentHashMap<>();
