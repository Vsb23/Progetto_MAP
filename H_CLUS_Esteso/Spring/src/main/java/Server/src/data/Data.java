...
import Server.src.database.DbAccess;
import Server.src.database.TableData;
import Server.src.database.EmptySetException;
import Server.src.database.DatabaseConnectionException;
import Server.src.database.MissingNumberException;

/**
 * <h2>La classe {@code Data} gestisce l'acquisizione e la manipolazione dei dati provenienti
 * da una tabella di un database relazionale che verranno utilizzati nell'h-clus.</h2>
 * <p>
...
public class Data {
	 ...
	 */
	 public Data(@Value("${database.table.name}") String tableName) throws NoDataException {
